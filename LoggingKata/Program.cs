...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ITrackable farthestLocationA = null;
            ITrackable farthestLocationB = null;
            ...
            {
                // Select one location at a time to act as the "starting point" or "origin" location.
                ...
                for (int j = i + 1; j < locations.Length; j++)
                {
                    ...
                    Console.WriteLine($"Farthest Taco Bell 1: {farthestLocationA.Name} at {farthestLocationA.Location.Latitude}, {farthestLocationA.Location.Longitude}");
                    Console.WriteLine($"Farthest Taco Bell 2: {farthestLocationB.Name} at {farthestLocationB.Location.Latitude}, {farthestLocationB.Location.Longitude}");
                }
            }
        }
